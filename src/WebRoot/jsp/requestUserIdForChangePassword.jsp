...
*/		
		...
		<table><tr><td align=\"center\"><p class=\"ttl18\"><h3>Change Password</h3></p></td></tr></table>
		

		<a name="skip" id="skip"></a>
			
		<form name="PasswordChangeForm" action="../../cadsrpasswordchange/promptUserID" method="POST" focus="userid" title="Use this screen to get your security questions">
 		<input type="hidden" name="<csrf:token-name/>" value="<csrf:token-value/>"/>

            <% if (errorMessage.equals("")) {
            		if (userMessage.equals("")) { %>
        				<p class=std>You will be prompted to change your password. If you have not setup the security questions, you will be redirected to the Setup Security Questions page.</p>
        			<%} else { %>
